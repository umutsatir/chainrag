        ...
        <div className="min-h-screen bg-gray-100 py-10 px-4 font-sans">
            <div className="max-w-3xl mx-auto">
                ...
                <div
                    ...
                    className="bg-white border border-gray-200 rounded-xl shadow-lg p-6 h-[600px] overflow-y-auto mb-6 flex flex-col space-y-4"
                >
                    {messages.length === 0 && (
                        <div className="text-center text-gray-400 mt-20">
                            <p>
                                Henüz bir mesaj yok. Blockchain hakkında bir
                                soru sor!
                            </p>
                        </div>
                    )}
                    ...
                    {messages.map((msg, idx) => (
                        ...
                        >
                            <div
                                className={`max-w-[80%] p-4 rounded-2xl shadow-sm break-words whitespace-pre-wrap ${
                                    msg.role === "user"
